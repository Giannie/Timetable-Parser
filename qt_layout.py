...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.target_choice_button, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.xml_line_edit, 4, 1, 1, 4)
        ...
        self.gridLayout.addWidget(self.xml_choice_button, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.genCalButton, 6, 0, 1, 1)
        self.target_line_edit = QtGui.QLineEdit(self.centralwidget)
        self.target_line_edit.setObjectName(_fromUtf8("target_line_edit"))
        self.gridLayout.addWidget(self.target_line_edit, 5, 1, 1, 4)
        self.quitButton = QtGui.QPushButton(self.centralwidget)
        self.quitButton.setObjectName(_fromUtf8("quitButton"))
        self.gridLayout.addWidget(self.quitButton, 7, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.workLabel, 6, 1, 1, 4)
